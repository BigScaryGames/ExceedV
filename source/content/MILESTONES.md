...
3. Earning income
4. polish perks,
5. Elemental zone traits - zones carry an element's trait, naturally or applied (AoE elemental spell gives its zone the trait for a turn; Limit spells can produce/sustain an element). Affinity perks ([[Minor Elemental Affinity]]) leach off the zone trait. Perk ladder: leach → consume the elemental effect → reaction: consume an incoming elemental spell → counter or relocate it.
