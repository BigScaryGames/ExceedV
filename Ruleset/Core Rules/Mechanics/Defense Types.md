...
|-------|----------------|----------|
| **#Strike** | Parry, Block, Dodge | Melee attacks, touch spells |
| **#Projectile** | Block, Dodge (Parry with perks) | Arrows, thrown weapons, targeted ranged spells |
| **#Burst** | Dodge (Block/Parry with perks) | Explosions, fireballs |
| **#Mind** | Endure | Fear, charm, mind control, mental distortion |
