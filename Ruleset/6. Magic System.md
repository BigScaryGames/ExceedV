...
| Tier | Basic Price | Advanced Price | XP to reach next tier |
| ---- | ----------- | -------------- | --------------------- |
| 0    | 1           | 3              |                       |
| 1    | 3           | 5              | 10                    |
| 2    | 5           | 7              | +20                   |
...
Learning a spell from a library or a spellbook requires Arcane Lore or Theology of an equal or higher level and a source from which to learn. Learning from other mage's - a teacher - bypass this.  As per [[3.4 Learning and Training]] learning a spell will take 1 unmodified day of learning per XP.
# Spells
